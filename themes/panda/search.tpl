...
<div class="clearfix">
<h1{if isset($instant_search) && $instant_search} id="instant_search_results"{/if} class="page-heading pull-left {if !isset($instant_search) || (isset($instant_search) && !$instant_search)} product-listing{/if}"> {l s='Search'}&nbsp;
    {if $nbProducts > 0}
        <span class="lighter">
...
{if isset($instant_search) && $instant_search}
    <a id="instant_search_close" href="#" class="pull-right">
