...
<section id="productscategory-products_block_center" class="page-product-box blockproductscategory products_block block section">
    <h3 class="title_block {if Configuration::get('STSN_PC_TITLE')} title_block_center {/if}">
        <span>
    		...
    		<div class="ajax_block_product {if $product@first}first_item{elseif $product@last}last_item{else}item{/if}">
                ...
                {capture name="pro_a_cart"}
                    {if isset($use_view_more_instead) && $use_view_more_instead==1}
                        <a class="view_button btn btn-default" href="{$smarty.capture.pro_link}" title="{l s='View more' mod='productscategory'}" rel="nofollow"><div><i class="icon-eye-2 icon-small icon_btn icon-mar-lr2"></i><span>{l s='View more' mod='productscategory'}</span></div></a>
                    {else}
