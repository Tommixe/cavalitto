                    ...
                    <div class="ajax_block_product {if $product@first}first_item{elseif $product@last}last_item{else}item{/if}">
                        ...
                        {capture name="pro_a_cart"}
                            {if isset($use_view_more_instead) && $use_view_more_instead==1}
                                <a class="view_button btn btn-default" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='View more' mod='crossselling'}" rel="nofollow"><div><i class="icon-eye-2 icon-small icon_btn icon-mar-lr2"></i><span>{l s='View more' mod='crossselling'}</span></div></a>
                            {else}
