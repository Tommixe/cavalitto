    ...
    <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
        <fieldset>
            ...
            <div id="login_form_content" style="display:none;">
                ...
                <p class="submit mar_t1">
                    {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
					<button type="submit" id="SubmitLogin" name="SubmitLogin" data-adv-api="1" class="btn btn-default">{l s='Sign in'}</button>
                </p>
            </div>
        </fieldset>
    </form>
            ...
            <div class="box">
                ...
                <div id="opc_account_form" class="unvisible">
                    ...
                    <div class="submit opc-add-save clearfix">
						...
						<button type="submit" name="submitAccount" id="submitAccount" data-adv-api="1" class="btn btn-default">{l s='Save'}</button>
					</div>
