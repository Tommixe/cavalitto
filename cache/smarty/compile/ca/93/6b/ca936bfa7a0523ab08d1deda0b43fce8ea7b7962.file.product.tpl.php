<?php /* Smarty version Smarty-3.1.19, created on 2016-01-04 15:04:45
         compiled from "/home/micreon/public_html/cavalitto/themes/panda/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2060607930568a7bfdb56db1-69725747%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca936bfa7a0523ab08d1deda0b43fce8ea7b7962' => 
    array (
      0 => '/home/micreon/public_html/cavalitto/themes/panda/product.tpl',
      1 => 1449302560,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2060607930568a7bfdb56db1-69725747',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'product' => 0,
    'sttheme' => 0,
    'pro_image_column_md' => 0,
    'pro_primary_column_md' => 0,
    'pro_secondary_column_md' => 0,
    'pro_image_column_sm' => 0,
    'pro_primary_column_sm' => 0,
    'pro_secondary_column_sm' => 0,
  ...
  'unifunc' => 'content_568a7bfe7e0760_65982207',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_568a7bfe7e0760_65982207')) {function content_568a7bfe7e0760_65982207($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/micreon/public_html/cavalitto/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home/micreon/public_html/cavalitto/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_function_math')) include '/home/micreon/public_html/cavalitto/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/micreon/public_html/cavalitto/tools/smarty/plugins/modifier.date_format.php';
?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php $_smarty_tpl->tpl_vars['pro_image_column_md'] = new Smarty_variable(Configuration::get('STSN_PRO_IMAGE_COLUMN_MD'), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['pro_primary_column_md'] = new Smarty_variable(Configuration::get('STSN_PRO_PRIMARY_COLUMN_MD'), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['pro_secondary_column_md'] = new Smarty_variable(Configuration::get('STSN_PRO_SECONDARY_COLUMN_MD'), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['pro_image_column_sm'] = new Smarty_variable(Configuration::get('STSN_PRO_IMAGE_COLUMN_SM'), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['pro_primary_column_sm'] = new Smarty_variable(Configuration::get('STSN_PRO_PRIMARY_COLUMN_SM'), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['pro_secondary_column_sm'] = new Smarty_variable(Configuration::get('STSN_PRO_SECONDARY_COLUMN_SM'), null, 0);?>
    <?php if (!$_smarty_tpl->tpl_vars['pro_image_column_md']->value) {?><?php $_smarty_tpl->tpl_vars['pro_image_column_md'] = new Smarty_variable(4, null, 0);?><?php }?>
    <?php if (!$_smarty_tpl->tpl_vars['pro_primary_column_md']->value) {?><?php $_smarty_tpl->tpl_vars['pro_primary_column_md'] = new Smarty_variable(5, null, 0);?><?php }?>
    <?php if ($_smarty_tpl->tpl_vars['pro_secondary_column_md']->value===false) {?><?php $_smarty_tpl->tpl_vars['pro_secondary_column_md'] = new Smarty_variable(3, null, 0);?><?php }?>
    <?php if (!$_smarty_tpl->tpl_vars['pro_image_column_sm']->value) {?><?php $_smarty_tpl->tpl_vars['pro_image_column_sm'] = new Smarty_variable(4, null, 0);?><?php }?>
    <?php if (!$_smarty_tpl->tpl_vars['pro_primary_column_sm']->value) {?><?php $_smarty_tpl->tpl_vars['pro_primary_column_sm'] = new Smarty_variable(5, null, 0);?><?php }?>
    <?php if ($_smarty_tpl->tpl_vars['pro_secondary_column_sm']->value===false) {?><?php $_smarty_tpl->tpl_vars['pro_secondary_column_sm'] = new Smarty_variable(3, null, 0);?><?php }?>
...
" />
		...
		<?php }?>
		<!-- left infos-->
		<div class="pb-left-column col-xs-12 col-sm-<?php echo $_smarty_tpl->tpl_vars['pro_image_column_sm']->value;?>
 col-md-<?php echo $_smarty_tpl->tpl_vars['pro_image_column_md']->value;?>
 ">
			<!-- product img-->
...
<?php } else { ?>javascript:;<?php }?>" <?php if ($_smarty_tpl->tpl_vars['enable_thickbox']->value) {?> data-fancybox-group="other-views" class="fancybox<?php if ($_smarty_tpl->tpl_vars['image']->value['id_image']==$_smarty_tpl->tpl_vars['cover']->value['id_image']) {?> shown<?php }?> replace-2x" <?php } else { ?> class="replace-2x"<?php }?> title="<?php echo $_smarty_tpl->tpl_vars['imageTitle']->value;?>
">
										<img class="replace-2x img-responsive" <?php if ($_smarty_tpl->tpl_vars['pro_image_column_md']->value>4) {?> src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'big_default'), ENT_QUOTES, 'UTF-8', true);?>
...
" data-fancybox-group="other-views" class="span_link no-print<?php if ($_smarty_tpl->tpl_vars['image']->value['id_image']==$_smarty_tpl->tpl_vars['cover']->value['id_image']) {?> shown<?php }?> replace-2x" title="<?php echo smartyTranslate(array('s'=>'View larger'),$_smarty_tpl);?>
"><i class="icon-resize-full icon-0x"></i></a>
				...
				<?php } else { ?>
					<div id="view_full_size">
						<img itemprop="image" <?php if ($_smarty_tpl->tpl_vars['pro_image_column_md']->value>4) {?> src="<?php echo $_smarty_tpl->tpl_vars['img_prod_dir']->value;?>
...
" height="<?php echo $_smarty_tpl->tpl_vars['largeSize']->value['height'];?>
" <?php }?> id="bigpic" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
...
">
										<img class="img-responsive replace-2x" id="thumb_<?php echo $_smarty_tpl->tpl_vars['image']->value['id_image'];?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
		...
		<!-- center infos -->
		<div class="pb-center-column col-xs-12 <?php if ($_smarty_tpl->tpl_vars['content_only']->value) {?> col-sm-<?php echo smarty_function_math(array('equation'=>'12-a','a'=>$_smarty_tpl->tpl_vars['pro_image_column_md']->value),$_smarty_tpl);?>
 <?php } else { ?> col-sm-<?php echo $_smarty_tpl->tpl_vars['pro_primary_column_sm']->value;?>
 col-md-<?php echo $_smarty_tpl->tpl_vars['pro_primary_column_md']->value;?>
<?php }?>">
...
<?php }?>
			<div class="product_meta_wrap clearfix"> 
				...
				<?php }?>
				<p id="product_reference" class="<?php if (!$_smarty_tpl->tpl_vars['display_pro_reference']->value) {?> unvisible <?php }?> product_meta" <?php if (empty($_smarty_tpl->tpl_vars['product']->value->reference)||!$_smarty_tpl->tpl_vars['product']->value->reference) {?> style="display: none;"<?php }?>>
					<label class="product_meta_label"><?php echo smartyTranslate(array('s'=>'Reference:'),$_smarty_tpl);?>
 </label>
					<span class="editable"<?php if ($_smarty_tpl->tpl_vars['enable_google_rich_snippets']->value) {?> itemprop="sku"<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->reference)&&$_smarty_tpl->tpl_vars['product']->value->reference) {?> content="<?php echo $_smarty_tpl->tpl_vars['product']->value->reference;?>
					...
					<div class="content_prices clearfix">
						<?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
							...
							<div class="price_box clearfix">
								<p class="our_price_display pull-left" <?php if ($_smarty_tpl->tpl_vars['enable_google_rich_snippets']->value) {?>itemprop="offers" itemscope itemtype="https://schema.org/Offer"<?php }?>><?php if ($_smarty_tpl->tpl_vars['enable_google_rich_snippets']->value) {?><?php if ($_smarty_tpl->tpl_vars['product']->value->quantity>0) {?><link itemprop="availability" href="https://schema.org/InStock"/><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?><span id="our_price_display" <?php if ($_smarty_tpl->tpl_vars['enable_google_rich_snippets']->value) {?>itemprop="price" content="<?php echo $_smarty_tpl->tpl_vars['productPrice']->value;?>
...
" /><?php }?><?php }?></p>
								...
								<?php }?>
								<p id="old_price" class="<?php if ((!$_smarty_tpl->tpl_vars['product']->value->specificPrice||!$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])) {?> hidden<?php }?> pull-left"><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayProductPriceBlock",'product'=>$_smarty_tpl->tpl_vars['product']->value,'type'=>"old_price"),$_smarty_tpl);?>
 ...
 <b id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
						...
						<div class="product_extra_info_wrap"> 
							...
							<p id="product_manufacturer_info" class="product_extra_info clearfix">
					            ...
					            <a <?php if ($_smarty_tpl->tpl_vars['enable_google_rich_snippets']->value) {?> itemprop="brand" itemscope="" itemtype="https://schema.org/Organization" <?php }?> href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['product_manufacturer']->value->id_manufacturer,$_smarty_tpl->tpl_vars['product_manufacturer']->value->link_rewrite);?>
...
<?php }?>
		...
		<!-- end center infos-->
		<!-- pb-right-column-->
		<?php if (($_smarty_tpl->tpl_vars['pro_secondary_column_md']->value||$_smarty_tpl->tpl_vars['pro_secondary_column_sm']->value)&&!$_smarty_tpl->tpl_vars['content_only']->value) {?>
			<div class="pb-right-column <?php if ($_smarty_tpl->tpl_vars['pro_secondary_column_sm']->value) {?> col-sm-<?php echo $_smarty_tpl->tpl_vars['pro_secondary_column_sm']->value;?>
<?php } else { ?> hidden-sm<?php }?> <?php if ($_smarty_tpl->tpl_vars['pro_secondary_column_md']->value) {?> col-md-<?php echo $_smarty_tpl->tpl_vars['pro_secondary_column_md']->value;?>
 col-xs-12<?php } else { ?> hidden<?php }?>">
				<?php if ($_smarty_tpl->tpl_vars['show_brand_logo']->value==1&&$_smarty_tpl->tpl_vars['product_manufacturer']->value->id_manufacturer) {?>
...
" rel="nofollow"><div><i class="icon-eye-2 icon-small icon_btn icon-mar-lr2"></i><span><?php echo smartyTranslate(array('s'=>'View more'),$_smarty_tpl);?>
						                	...
						                	<?php } else { ?>
												<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&$_smarty_tpl->tpl_vars['add_prod_display']->value==1) {?>
											  		<a class="ajax_add_to_cart_button btn btn-default" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
