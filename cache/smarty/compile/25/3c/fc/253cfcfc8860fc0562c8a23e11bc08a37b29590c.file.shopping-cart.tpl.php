<?php /* Smarty version Smarty-3.1.19, created on 2016-01-04 15:03:00
         compiled from "/home/micreon/public_html/cavalitto/themes/panda/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53531745568a7b942b2d04-49798054%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '253cfcfc8860fc0562c8a23e11bc08a37b29590c' => 
    array (
      0 => '/home/micreon/public_html/cavalitto/themes/panda/shopping-cart.tpl',
      1 => 1449302560,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53531745568a7b942b2d04-49798054',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_568a7b94724043_67732149',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_568a7b94724043_67732149')) {function content_568a7b94724043_67732149($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/micreon/public_html/cavalitto/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php if (isset($_smarty_tpl->tpl_vars['empty']->value)) {?>
    ...
    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','location'=>"11",'mod'=>'steasycontent','caller'=>'steasycontent'),$_smarty_tpl);?>
...
">
	...
	<?php if (!isset($_smarty_tpl->tpl_vars['empty']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
		<p class="color_666"><?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
...
<?php }?></span>
	...
	<div id="order-detail-content" class="table_block">
		<table id="cart_summary" class="table table-bordered resp_table <?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>stock-management-on<?php } else { ?>stock-management-off<?php }?>">
			<thead>
				<tr>
...
<?php if ($_smarty_tpl->tpl_vars['odd']->value) {?> odd<?php } else { ?> even<?php }?> customization alternate_item <?php if ($_smarty_tpl->tpl_vars['product']->last&&$_smarty_tpl->tpl_vars['customization']->last&&!count($_smarty_tpl->tpl_vars['gift_products']->value)) {?>last_item<?php }?>">
								<td></td>
								<td colspan="3" data-title="<?php echo smartyTranslate(array('s'=>'Description'),$_smarty_tpl);?>
">
...
<?php echo $_smarty_tpl->tpl_vars['textField']->index+1;?>
								...
								<td class="cart_quantity text-center" colspan="1" data-title="<?php echo smartyTranslate(array('s'=>'Qty'),$_smarty_tpl);?>
">
									<div class="mobile_table_content">
...
_<?php echo $_smarty_tpl->tpl_vars['id_customization']->value;?>
"
													class="cart_quantity_down disabled"
													href="#"
													title="<?php echo smartyTranslate(array('s'=>'Subtract'),$_smarty_tpl);?>
">-</a>
											<?php }?>
...
<?php }?>" method="post" id="voucher">
				<fieldset>
					<p class="cart_voucher_title"><?php echo smartyTranslate(array('s'=>'Vouchers'),$_smarty_tpl);?>
</p>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
						<tr class="cart_total_price">
							<td class="color_666"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total products (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
					...
					<?php } else { ?>
						<tr class="cart_total_price">
							<td class="color_666"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total products (tax incl.)'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
				...
				<?php } else { ?>
					<tr class="cart_total_price">
						<td class="color_666"><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
</td>
						<td class="price" id="total_product"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
</td>
					</tr>
...
<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&(!isset($_smarty_tpl->tpl_vars['isVirtualCart']->value)||!$_smarty_tpl->tpl_vars['isVirtualCart']->value)&&$_smarty_tpl->tpl_vars['free_ship']->value) {?>
					<tr class="cart_total_delivery<?php if (!$_smarty_tpl->tpl_vars['opc']->value&&(!isset($_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)||!$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)) {?> unvisible<?php }?>">
						<td class="color_666"><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
</td>
					...
					<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value!=$_smarty_tpl->tpl_vars['total_shipping']->value) {?>
						<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
							<tr class="cart_total_delivery<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0) {?> unvisible<?php }?>">
								<td class="color_666"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total shipping (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
						...
						<?php } else { ?>
							<tr class="cart_total_delivery<?php if ($_smarty_tpl->tpl_vars['total_shipping']->value<=0) {?> unvisible<?php }?>">
								<td class="color_666"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total shipping (tax incl.)'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></td>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value&&$_smarty_tpl->tpl_vars['total_tax']->value!=0) {?>
					...
					<tr class="cart_total_price">
						<td class="color_666"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
					...
					<tr class="cart_total_tax">
						<td class="color_666"><?php echo smartyTranslate(array('s'=>'Tax'),$_smarty_tpl);?>
</td>
...
$_smarty_tpl->tpl_vars['addresses_style']->value['alias'] = 'address_title';?>
	...
	<?php if (((isset($_smarty_tpl->tpl_vars['advanced_payment_api']->value)&&!$_smarty_tpl->tpl_vars['advanced_payment_api']->value)||!isset($_smarty_tpl->tpl_vars['advanced_payment_api']->value))&&((!empty($_smarty_tpl->tpl_vars['delivery_option']->value)&&(!isset($_smarty_tpl->tpl_vars['isVirtualCart']->value)||!$_smarty_tpl->tpl_vars['isVirtualCart']->value))||$_smarty_tpl->tpl_vars['delivery']->value->id||$_smarty_tpl->tpl_vars['invoice']->value->id)&&!$_smarty_tpl->tpl_vars['opc']->value) {?>
...
<?php }?>" class="pull-right btn btn-default standard-checkout" title="<?php echo smartyTranslate(array('s'=>'Proceed to checkout'),$_smarty_tpl);?>
">
...
<?php }?>" class="pull-left btn btn-default" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
">
