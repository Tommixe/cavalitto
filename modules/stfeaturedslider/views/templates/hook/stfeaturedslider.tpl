...
<div id="featured_products_sldier_block_center_container_{$hook_hash}" class="featured_products_sldier_block_center_container {if $hide_mob} hidden-xs {/if} block{if $countdown_on} s_countdown_block{/if}">
