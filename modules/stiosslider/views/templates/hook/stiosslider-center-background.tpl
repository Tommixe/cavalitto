...
<div id="iosSlider_containerOuter_{$slide.id_st_iosslider_group}" class="containerOuter_center_background {if $slide['location']!=14 && $slide['hide_on_mobile']} hidden-xs {/if} iosSlider_tb{$slide['padding_tb']} block">
...
<div id="iosSlider_{$slide.id_st_iosslider_group}" class="iosSlider center_background">
    <div class="slider clearfix">
        ...
        {foreach $slide['slide'] as $banner}
            <div id="iosSliderBanner_{$banner.id_st_iosslider}" class="iosSliderBanner_{$banner.id_st_iosslider} iosSlideritem" style="height:{if $slide.height}{$slide.height}{else}500{/if}px;">
