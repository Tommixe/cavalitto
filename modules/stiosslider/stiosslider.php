...
class StIosSlider extends Module
{
    ...
    public static $location = array(
        20 => array('id' =>20 , 'name' => 'Full width top', 'hook' => 'FullWidthTop', 'templates' => array(0,1,2,3), 'full_width' => 1),
        23 => array('id' =>23 , 'name' => 'Full width top 2', 'hook' => 'FullWidthTop2', 'templates' => array(0,1,2,3), 'full_width' => 1),
        18 => array('id' =>18 , 'name' => 'Top column', 'hook' => 'TopColumn', 'templates' => array(0,1,2)),
        4 => array('id' =>4 , 'name' => 'Homepage top', 'hook' => 'HomeTop', 'templates' => array(0,2)),
        3 => array('id' =>3 , 'name' => 'Homepage', 'hook' => 'Home', 'templates' => array(0,2)),
        17 => array('id' =>17 , 'name' => 'Homepage bottom', 'hook' => 'HomeBottom', 'templates' => array(0,2)),
        19 => array('id' =>19 , 'name' => 'Bottom column', 'hook' => 'BottomColumn', 'templates' => array(0,1,2)),
        21 => array('id' =>21 , 'name' => 'Full width Bottom', 'hook' => 'FullWidthBottom', 'templates' => array(0,1,2), 'full_width' => 1),
        7 => array('id' =>7 , 'name' => 'Blog homepage top(fullwidth)', 'hook' => 'FullWidthTop', 'templates' => array(0,1,2,3), 'full_width' => 1),
        8 => array('id' =>8 , 'name' => 'Blog homepage top', 'hook' => 'FullWidthTop', 'templates' => array(0,1,2)),
        6 => array('id' =>6 , 'name' => 'Blog homepage', 'hook' => 'StBlogHome', 'templates' => array(0,2)),
        11 => array('id' =>11 , 'name' => 'At bottom of product page', 'hook' => 'FooterProduct', 'templates' => array(0,2)),
        12 => array('id' =>12 , 'name' => 'At bottom of category page', 'hook' => 'CategoryFooter', 'templates' => array(0,2)),
        22 => array('id' =>22 , 'name' => 'Most top of the page', 'hook' => 'Banner', 'templates' => array(3), 'full_width' => 1),
    );
    ...
    public function hookDisplayFullWidthTop2($params)
    {
        ...
        if($page_name=='index')
        {
            if (!$this->isCached('stiosslider.tpl', $this->stGetCacheId(23)))
                if(!$this->_prepareHook(23,1))
                    return false;
            return $this->display(__FILE__, 'stiosslider.tpl', $this->stGetCacheId(23));
        }
        return false;
    }
    ...
    {
        $location = array();
        foreach(Db::getInstance()->executeS('SELECT location FROM `'._DB_PREFIX_.'st_iosslider_group` GROUP BY location') AS $value)
