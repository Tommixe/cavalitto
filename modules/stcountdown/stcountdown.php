    ...
    public function initFieldsForm()
    {
                ...
                array(
                    ...
                    'values' => array(
                        array(
                            'id' => 'style_0',
                            'value' => 0,
                            'label' => $this->l('00 days 00 hours 00 minutes 00 secondes')),
                        array(
                            'id' => 'style_1',
                            'value' => 1,
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->l('Countdown box vertical alignment:'),
                    'name' => 'v_alignment',
                    'default_value' => 0,
                    'values' => array(
                        array(
        ...
        $this->fields_form[3]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display on the "Specials block" module:'),
                    'name' => 'blkspecial',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display on the "Top-sellers block" module:'),
                    'name' => 'blkbest',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display on the "Featured products on the homepage" module:'),
                    'name' => 'blkfeatured',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
    ...
    public function hookDisplayHeader($params)
    {
        ...
        if (!$this->isCached('header.tpl', $cache_id))
        {
            ...
            if ($text_color = Configuration::get($this->_prefix_st.'TEXT_COLOR'))
                $custom_css .= '.countdown_wrap{color:'.$text_color.';}';

            if($bg = Configuration::get($this->_prefix_st.'BG'))
            {
                $custom_css .= '.countdown_wrap{background:'.$bg.';}';  
                ...
                if(is_array($bg_arr))
                {
                    ...
                    if($bg_opacity<0 || $bg_opacity>1)
                        $bg_opacity = 0.8;
                    $custom_css .= '.countdown_wrap{background:rgba('.$bg_arr[0].','.$bg_arr[1].','.$bg_arr[2].','.$bg_opacity.');}';  
                }
            }

            if ($number_size = Configuration::get($this->_prefix_st.'NUMBER_SIZE'))
                $custom_css .= '.countdown_timer.countdown_style_0 div span.countdown_number, .countdown_timer.countdown_style_1 div{font-size:'.$number_size.'px;}';
            ...
            if ($font_trans = Configuration::get($this->_prefix_st.'FONT_TRANS'))
                $custom_css .= '.countdown_wrap{text-transform:'.self::$textTransform[(int)$font_trans]['name'].';}';
            ...
            if ($pro_text_color = Configuration::get($this->_prefix_st.'PRO_TEXT_COLOR'))
                $custom_css .= '.countdown_box{color:'.$pro_text_color.';}';
            if ($pro_bg = Configuration::get($this->_prefix_st.'PRO_BG'))
                $custom_css .= '.countdown_box{background:'.$pro_bg.';}';
            if ($pro_font_size = Configuration::get($this->_prefix_st.'PRO_FONT_SIZE'))
                $custom_css .= '.countdown_box{font-size:'.$pro_font_size.';}';
            if ($pro_font_trans = Configuration::get($this->_prefix_st.'PRO_FONT_TRANS'))
                $custom_css .= '.countdown_box{text-transform:'.self::$textTransform[(int)$pro_font_trans]['name'].';}';
            ...
            if($fontNumber)
                $custom_css .= '.countdown_timer.countdown_style_0 div span.countdown_number, .countdown_timer.countdown_style_1 div{'.($fontNumber != $this->_font_inherit ? 'font-family: "'.$fontNumber.'";' : '').$fontTextWeight.$fontTextStyle.'}';
            if($fontText)
                $custom_css .= '.countdown_timer.countdown_style_0 div span.countdown_text{'.($fontText != $this->_font_inherit ? 'font-family: "'.$fontNumber.'";' : '').$fontTextWeight.$fontTextStyle.'}';
            if($fontProText)
                $custom_css .= '.countdown_box span{'.($fontProText != $this->_font_inherit ? 'font-family: "'.$fontNumber.'";' : '').$fontProTextWeight.$fontProTextStyle.'}';
