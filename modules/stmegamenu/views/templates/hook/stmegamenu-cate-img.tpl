...
*}
<a href="{$menu_cate.link|escape:'html':'UTF-8'}"{if !$menu_title} title="{$menu_cate.name|escape:'html':'UTF-8'}"{/if} class="menu_cate_img"{if $nofollow} rel="nofollow"{/if}{if $new_window} target="_blank"{/if}>
