...
class ShippingquoteValidationModuleFrontController extends ModuleFrontController
{
    ...
    $cart_url = Tools::getProtocol().htmlentities($_SERVER['HTTP_HOST'], ENT_COMPAT, 'UTF-8').$admin_dir.'index.php?controller=AdminCarts&id_cart='.$id_cart.'&viewcart&token='.$cart_token;
