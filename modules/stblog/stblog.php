...
class StBlog extends Module
{
    ...
    public static $moduleRoutes = array(
        ...
        'module-stblog-article' => array(
            'controller' =>  'article',
            'rule' =>        'blog/{id_blog}_{rewrite}.html',
            'keywords' => array(
    ...
    public static $moduleRoutes_154 = array(
        'module-stblog-category' => array(
            'controller' =>  'category',
            'rule' =>        'module/{module}/category/{blog_id_category}-{rewrite}',
            'keywords' => array(
                'blog_id_category'            =>   array('regexp' => '[0-9]+', 'param' => 'blog_id_category'),
                'rewrite'       =>   array('regexp' => '[_a-zA-Z0-9-\pL]*'),
        ...
        'module-stblog-article' => array(
            'controller' =>  'article',
            'rule' =>        'module/{module}/{id_blog}_{rewrite}.html',
            'keywords' => array(
                'id_blog'            =>   array('regexp' => '[0-9]+', 'param' => 'id_blog'),
                'rewrite'       =>   array('regexp' => '[_a-zA-Z0-9-\pL]*'),
				'module' =>			array('regexp' => '[_a-zA-Z0-9_-]+', 'param' => 'module'),
