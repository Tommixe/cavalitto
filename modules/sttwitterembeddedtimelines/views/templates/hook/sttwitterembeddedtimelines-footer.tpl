...
<section class="col-xs-12 col-sm-{if $wide_on_footer}{$wide_on_footer}{else}3{/if} block">
    <a href="javascript:;" class="opener visible-xs">&nbsp;</a>
    <h3 class="title_block">{l s='Latest tweets' mod='sttwitterembeddedtimelines'}</h3>
