...
class StOwlCarousel extends Module
{
    ...
    public static $location = array(
        ...
        25 => array('id' =>25 , 'name' => 'Homepage secondary left', 'hook' => 'HomeSecondaryLeft'),
        23 => array('id' =>23 , 'name' => 'Homepage tertiary left', 'hook' => 'HomeTertiaryLeft'),
        24 => array('id' =>24 , 'name' => 'Homepage tertiary right', 'hook' => 'HomeTertiaryRight'),
        ...
        2 => array('id' =>2 , 'name' => 'Left column', 'hook' => 'LeftColumn'),
        5 => array('id' =>5 , 'name' => 'Right column', 'hook' => 'RightColumn'),
        7 => array('id' =>7 , 'name' => 'Blog homepage top(fullwidth)', 'hook' => 'FullWidthTop', 'full_width' => 1),
        8 => array('id' =>8 , 'name' => 'Blog homepage top', 'hook' => 'FullWidthTop'),
        6 => array('id' =>6 , 'name' => 'Blog homepage', 'hook' => 'StBlogHome'),
        9 => array('id' =>9 , 'name' => 'Blog left column', 'hook' => 'StBlogLeftColumn'),
        10 => array('id' =>10 , 'name' => 'Blog right column', 'hook' => 'StBlogRightColumn'),
        ...
        16 => array('id' =>16 , 'name' => 'Product secondary column', 'hook' => 'ProductSecondaryColumn'),
    );
        ...
        if (!$this->isCached('header.tpl', $this->getCacheId()))
        {
            ...
            if (is_array($custom_css_arr) && count($custom_css_arr)) {
                foreach ($custom_css_arr as $v) {
                    ...
                    if($v['text_bg'])
                        $custom_css .= '#st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h1, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h2, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h3, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h4, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h5, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h6, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content p{padding: 2px 0.3em;background-color:'.$v['text_bg'].';background-color:rgba('.self::hex2rgb($v['text_bg']).',0.4);}#st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content p{padding: 0.4em 0.6em;}';
                    if($v['btn_color'])
    ...
    {
        $location = array();
        foreach(Db::getInstance()->executeS('SELECT location FROM `'._DB_PREFIX_.'st_owl_carousel_group` GROUP BY location') AS $value)
