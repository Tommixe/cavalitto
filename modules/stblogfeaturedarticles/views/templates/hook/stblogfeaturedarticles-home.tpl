...
<div id="st_blog_featured_article_container_{$hook_hash}" class="st_blog_featured_article_container block">
{if isset($homeverybottom) && $homeverybottom}<div class="wide_container"><div class="container">{/if}
<section id="st_blog_featured_article_{$hook_hash}" class="st_blog_featured_article section">
    ...
    <div id="featured_article_slider_{$hook_hash}" class="products_slider">
    ...
    {literal}
    jQuery(function($) { 
        var owl = $("#featured_article_slider_{/literal}{$hook_hash}{literal} .slides");
        owl.owlCarousel({
            {/literal}
