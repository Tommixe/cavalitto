...
class StParallax extends Module
{
    ...
    public static $location = array(
        ...
        38 => array('id' =>38 , 'name' => 'Full width top 2', 'hook' => 'FullWidthTop2', 'full_width' => 1),
        ...
        4 => array('id' =>4 , 'name' => 'Homepage top', 'hook' => 'HomeTop'),
    ...
    {
        $location = array();
        foreach(Db::getInstance()->executeS('SELECT location FROM `'._DB_PREFIX_.'st_parallax_group` GROUP BY location') AS $value)
