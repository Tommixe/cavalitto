...
var delBackgroundStyle = function(){
    $('.panel[id^="fieldset_2"],.panel[id^="fieldset_3"],.panel[id^="fieldset_4"]').hide();
    var b_s = $('input[name="background_style"]:checked').val();
    $('.panel[id^="fieldset_'+(parseInt(b_s)+2)+'"]').fadeIn();
    return true;
};
